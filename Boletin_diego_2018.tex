...
\begin{figure}
  \centering
  \includegraphics[width=0.32\columnwidth]{img_171.pdf}
  \includegraphics[width=0.32\columnwidth]{img_193.pdf}
  \includegraphics[width=0.32\columnwidth]{img_211.pdf}
  \caption{AIA/SDO.}
  \label{fig_00}
\end{figure}
...
\begin{figure}
  \centering
  \includegraphics[width=0.4\textwidth]{map_ne_aia.pdf}\\
  \includegraphics[width=0.4\textwidth]{map_ne_kcor.pdf}
  \caption{AIA/SDO.}
  \label{fig_maps}
\end{figure}
...
\begin{figure*}
  \centering
  \includegraphics[width=0.4\textwidth]{comparison_quiet_region.pdf}
  \includegraphics[width=0.4\textwidth]{comparison_open.pdf}\\
  \includegraphics[width=0.4\textwidth]{Average_Radial_Profiles_KCOR-Tom_vs_DEMT_CR2198_Hh_l45_kcor_subreg-Quiet-region1.pdf}
  \includegraphics[width=0.4\textwidth]{Average_Radial_Profiles_KCOR-Tom_vs_DEMT_CR2198_Hh_l45_kcor_subreg-Open-region_N.pdf}
  \caption{AIA/SDO.}
