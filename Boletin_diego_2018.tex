...
Figure \ref{fig_images} shows examples of coronal images of this rotation. The left panel shows a coronal EUV image taken by the SDO/AIA instrument in the $211~\rm{\AA}$ band. The right panel shows a coronal polarized brightnes (pB) white light (WL) image. Both images were taken nearly-simultaneously, on 2017 December 03 UT 18:00-19:00, roughly the beginning of CR-2198. The longitude of the disk center in these images is $\approx 0^\circ$, so that ARs are not seen here, and the image is dominated by the quiet sun streamer belt and and the CHs.
