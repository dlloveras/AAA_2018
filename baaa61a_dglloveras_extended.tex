...
\begin{figure*}[t]
  ...
  \includegraphics[width=\columnwidth]{map_ne_kcor.pdf}
  \caption{Same as Fig. \ref{fig_maps} but with left panel showing the reconstruction based on EUV data blocking all pixels at projected radius $r<1.09~\rm{R}_\odot$, and using 4 images per day.}
  \label{fig_maps2}
\end{figure*}
...
\begin{figure*}[!ht]
  ...
  \caption{Same as Figure \ref{fig_analysis}.}
  \label{fig_analysis2}
\end{figure*}
...
\begin{figure*}[]
  ...
  \includegraphics[width=\columnwidth]{map_ne_kcor.pdf}
  \caption{Same as Fig. \ref{fig_maps2} but with left panel showing the reconstruction based on EUV data blocking all pixels at projected radius $r<1.09~\rm{R}_\odot$, and using 1 image per day.}
  \label{fig_maps3}
\end{figure*}
