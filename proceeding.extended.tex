...
\begin{figure*}[]
  ...
  \caption{Same as Fig. \ref{fig_maps} but with the left panel showing the DEMT reconstruction based on EUV images blocked at projected radius $r<1.09~\rm{R}_\odot$, using 1 image per day. Regularization level \
...
\begin{figure*}[!h]
  \centering
  \includegraphics[width=\columnwidth]{comparison_KCOR-Tom_vs_DEMT_CR2208_h_l1069_reduced_kcor_6e5_newgrid-Quiet-region_ratio_range1105-1195_Rsun.pdf}
  ...
  \includegraphics[width=0.75\columnwidth]{Average_Radial_Profiles_KCOR-Tom_vs_DEMT_CR2208_h_l1069_reduced_kcor_6e5_newgrid-Quiet-region.pdf}
  \hskip 2cm
